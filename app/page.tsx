  ...
  return (
    <main className="min-h-screen overflow-hidden">
      ...
      <header className="mx-auto flex w-full max-w-6xl items-center justify-between px-5 py-6 sm:px-8">
        <a href="#converter" className="flex items-center gap-3 font-semibold tracking-tight"><span className="logo-mark"><Scale size={20} strokeWidth={1.8} /></span><span>Prutah</span></a>
